...
<body>
    ...
    <ul>
        <li><strong>OpenLDAP</strong>: Service d'annuaire pour la gestion des identifiants et données utilisateur.</li>
        <li><strong>PHP</strong>: Hébergement et exécution d'applications PHP, en liaison avec OpenLDAP.</li>
        <li><strong>phpLDAPadmin</strong>: Interface web pour la gestion de l'annuaire OpenLDAP.</li>
